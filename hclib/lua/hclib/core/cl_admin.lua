...
local function SynchPermissions(  )

    local pg = HCLIB:ReadCompressedTable();

    local p = HCLIB:ReadCompressedTable();

    HCLIB.Admin.PermissionGroups = pg;

    HCLIB.Admin.Permissions = p;

end;

local function SendPermission()
