...
!! I COPYED FROM GMOD VGUI, BECAUSE WHEN I HAVE SOME PROBLEMS WITH THIS I CAN EASY CHANGE IT !!
...
function PANEL:Init()
	...
	self.VBar = vgui.Create( "HCLIB.DVScroll", self )
...
derma.DefineControl( "HCLIB.Scroll", "", PANEL, "DPanel" )